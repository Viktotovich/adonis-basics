...
export default class Movie extends BaseModel {
  ...
  /*verbose options / didn't include as it is the defaults
  {
    localKey: 'id',
    relatedKey: 'id',
  ...
  @manyToMany(() => Cineast, {
    ...
    pivotTimestamps: true,
    //eager load >> Adonis provides it when this relation is loaded
  ...
  //https://lucid.adonisjs.com/docs/model-hooks#hooks

  @beforeCreate()
  static async slugify(movie: Movie) {
    if (movie.slug) return

    //string is Adonis's built in helper to create slugs
